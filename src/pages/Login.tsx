      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center p-12">
          <div className="text-primary-foreground max-w-md text-center">
            ...
            >
              <div className="w-20 h-20 rounded-2xl bg-primary-foreground/20 mx-auto mb-6 flex items-center justify-center">
              ...
              <p className="text-lg opacity-90">
                Join 100,000+ students who are earning money by sharing their study notes with peers worldwide.
              </p>
            </motion.div>
          </div>
        </div>
